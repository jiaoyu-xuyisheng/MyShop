	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form id="myform" class="form-horizontal" action="${pageContext.request.contextPath}/userServlet?method=register" style="margin-top: 5px;">
					...
					<div class="form-group opt">
						...
						<div class="col-sm-6">
							<label class="radio-inline"> <input type="radio"
								...
								name="sex" id="sex2" value="female" name="sex">
								女
							</label>
							<label class="error" for="sex" style="display:none">请填写性别！！</label>
						</div>
					</div>
					<div class="form-group">
					格式：2017-12-12
