...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<div style="margin-right:130px;">
				...
				<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
					...
					<a href="${pageContext.request.contextPath }/myproductServlet?method=submitOrder">
		...
		<c:if test="${empty cart.cartItems }">
			<img src="${pageContext.request.contextPath}/img/cart-empty.png"></img>
			<a href="${pageContext.request.contextPath}">去首页去购物吧</a>
		</c:if>
		
		<script>
			function delPro(pid){
				if(confirm("你确定要删除该项吗？")){
					location.href="${pageContext.request.contextPath}/myproductServlet?method=delProFromCart&pid="+pid;
				}
			}
			
			function clearCart(){
				if(confirm("确定要清空购物车吗")){
					location.href="${pageContext.request.contextPath}/myproductServlet?method=clearCart";
				}
			}
		</script>
