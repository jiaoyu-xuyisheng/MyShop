	...
	<HEAD>
		...
		<script type="text/javascript">
			...
			function findOrderInfoByOid(oid){
				$('#shodDivOid').html(oid);
				var mycontent="<tr id='showTableTitle'><th width='20%'>图片</th><th width='25%'>商品</th><th width='20%'>价格</th><th width='15%'>数量</th><th width='20%'>小计</th></tr>";
				$.post('${pageContext.request.contextPath}/adminServlet?method=showOneOrder',{"oid":oid},
				function(data){				
					for(var i=0;i<data.length;i++){
						mycontent+="<tr style='text-align: center;'>"
							+"<td>"
