				...
				<td class="ta_01" align="center" bgColor="#f5fafe">
					<table cellspacing="0" cellpadding="1" rules="all"
						...
						<tr class='mytr'>
								...
								<a href="${ pageContext.request.contextPath }/adminServlet?method=editCategory&cname=${category.cname}&cid=${category.cid}">
										<img src="${pageContext.request.contextPath}/images/i_edit.gif" border="0" style="CURSOR: hand">
								</a></td>

								<td align="center" style="HEIGHT: 22px">
									<a href="${ pageContext.request.contextPath }/adminServlet?method=delCategoryAtList&cid=${category.cid}">
